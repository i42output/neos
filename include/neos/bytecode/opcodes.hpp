...
#include <neolib/core/leb128.hpp>

#include <neos/bytecode/exceptions.hpp>

namespace neos
{
    using namespace neolib::leb128;
    ...
    namespace bytecode
    {
        ...
        struct op2 { std::uint8_t p; oleb128 e; constexpr std::strong_ordering operator<=>(op2 const&) const noexcept = default; };
