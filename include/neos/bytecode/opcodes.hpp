...
namespace neos
{
    namespace bytecode
    {
        ...
        enum class opcode 
        {
            ...
            Br,             BrIf,          BrTable,       Return,        Call,          CallIndirect,  Drop,
            Select,         LocalGet,      LocalSet,      LocalTee,      GlobalGet,     GlobalSet,     I32Load,
            I64Load,        F32Load,       F64Load,       I32Load8S,     I32Load8U,     I32Load16S,    I32Load16U,
            ...
            I64Store32,     MemorySize,    MemoryGrow,    I32Const,      I64Const,      F32Const,      F64Const,
            I32Eqz,         I32Eq,         I32Ne,         I32LtS,        I32LtU,        I32GtS,        I32GtU,
            I32LeS,         I32LeU,        I32GeS,        I32GeU,        I64Eqz,        I64Eq,         I64Ne,
            I64LtS,         I64LtU,        I64GtS,        I64GtU,        I64LeS,        I64LeU,        I64GeS,
            I64GeU,         F32Eq,         F32Ne,         F32Lt,         F32Gt,         F32Le,         F32Ge,
            F64Eq,          F64Ne,         F64Lt,         F64Gt,         F64Le,         F64Ge,         I32Clz,
            I32Ctz,         I32Popcnt,     I32Add,        I32Sub,        I32Mul,        I32DivS,       I32DivU,
            I32RemS,        I32RemU,       I32And,        I32Or,         I32Xor,        I32Shl,        I32ShrS,
            ...
            I32ReinterpretF32, I64ReinterpretF64, F32ReinterpretI32, F64ReinterpretI64, I32Extend8S, I32Extend16S,
            I64Extend8S,    I64Extend16S,  I64Extend32S,

            // Extended Opcodes (0xFB prefix) - Garbage Collection
            StructNew,      StructNewDefault, StructGet,  StructGetS,    StructGetU,    StructSet,     ArrayNew,
            ArrayNewDefault, ArrayNewData, ArrayNewElem, ArrayNewFixed, ArrayGet,      ArrayGetS,     ArrayGetU,
            ArraySet,       ArrayLen,      ArrayFill,     ArrayCopy,     ArrayInitData, ArrayInitElem, RefI31,
            I31GetS,        I31GetU,       RefTest,       RefCast,       BrOnCast,      BrOnCastFail,  AnyConvertExtern,
            ExternConvertAny, RefIsFunc,   RefIsData,     RefIsI31,      RefAsFunc,     RefAsData,     RefAsI31,
            BrOnFunc,       BrOnData,      BrOnI31,       BrOnNonFunc,   BrOnNonData,   BrOnNonI31,

            // Extended Opcodes (0xFC prefix) - Bulk Memory and Saturating Conversions
            I32TruncSatF32S, I32TruncSatF32U, I32TruncSatF64S, I32TruncSatF64U, I64TruncSatF32S, I64TruncSatF32U,
            I64TruncSatF64S, I64TruncSatF64U, MemoryInit,    DataDrop,      MemoryCopy,    MemoryFill,    TableInit,
            ElemDrop,       TableCopy,     TableGrow,     TableSize,     TableFill,
            ...
            V128Load8Splat, V128Load16Splat, V128Load32Splat, V128Load64Splat, V128Store,   V128Const,     I8x16Shuffle,
            I8x16Swizzle,   I8x16Splat,    I16x8Splat,    I32x4Splat,    I64x2Splat,    F32x4Splat,    F64x2Splat,
            ...
            F64x2ExtractLane, F64x2ReplaceLane, I8x16Eq,     I8x16Ne,       I8x16LtS,      I8x16LtU,      I8x16GtS,
            I8x16GtU,       I8x16LeS,      I8x16LeU,      I8x16GeS,      I8x16GeU,      I16x8Eq,       I16x8Ne,
            I16x8LtS,       I16x8LtU,      I16x8GtS,      I16x8GtU,      I16x8LeS,      I16x8LeU,      I16x8GeS,
            I16x8GeU,       I32x4Eq,       I32x4Ne,       I32x4LtS,      I32x4LtU,      I32x4GtS,      I32x4GtU,
            I32x4LeS,       I32x4LeU,      I32x4GeS,      I32x4GeU,      F32x4Eq,       F32x4Ne,       F32x4Lt,
            F32x4Gt,        F32x4Le,       F32x4Ge,       F64x2Eq,       F64x2Ne,       F64x2Lt,       F64x2Gt,
            F64x2Le,        F64x2Ge,       V128Not,       V128And,       V128AndNot,    V128Or,        V128Xor,
            V128BitSelect,  V128AnyTrue,   V128Load32Zero, V128Load64Zero, I8x16Abs,     I8x16Neg,      I8x16Popcnt,
            I8x16AllTrue,   I8x16Bitmask,  I8x16NarrowI16x8S, I8x16NarrowI16x8U, I8x16Add,   I8x16AddSatS,  I8x16AddSatU,
            I8x16Sub,       I8x16SubSatS,  I8x16SubSatU,  I8x16MinS,     I8x16MinU,     I8x16MaxS,     I8x16MaxU,
            I16x8Abs,       I16x8Neg,      I16x8Q15MulRSatS, I16x8AllTrue, I16x8Bitmask, I16x8NarrowI32x4S, I16x8NarrowI32x4U,
            I16x8ExtendLowI8x16S, I16x8ExtendHighI8x16S, I16x8ExtendLowI8x16U, I16x8ExtendHighI8x16U, I16x8Add, I16x8AddSatS,
            I16x8AddSatU,  I16x8Sub,      I16x8SubSatS,  I16x8SubSatU,  I16x8Mul,      I16x8MinS,     I16x8MinU,
            I16x8MaxS,      I16x8MaxU,     I16x8ExtMulLowI8x16S, I16x8ExtMulHighI8x16S, I16x8ExtMulLowI8x16U, I16x8ExtMulHighI8x16U,
            I32x4Abs,       I32x4Neg,      I32x4AllTrue,  I32x4Bitmask,  I32x4ExtendLowI16x8S, I32x4ExtendHighI16x8S,
            I32x4ExtendLowI16x8U, I32x4ExtendHighI16x8U, I32x4Add,    I32x4Sub,      I32x4Mul,      I32x4MinS,
            I32x4MinU,      I32x4MaxS,     I32x4MaxU,     I32x4DotI16x8S, I32x4ExtMulLowI16x8S, I32x4ExtMulHighI16x8S,
            I32x4ExtMulLowI16x8U, I32x4ExtMulHighI16x8U, I64x2Abs,    I64x2Neg,      I64x2AllTrue,  I64x2Bitmask,
            I64x2ExtendLowI32x4S, I64x2ExtendHighI32x4S, I64x2ExtendLowI32x4U, I64x2ExtendHighI32x4U, I64x2Add, I64x2Sub,
            ...
            F32x4Min,       F32x4Max,      F64x2Abs,      F64x2Neg,      F64x2Sqrt,     F64x2Add,      F64x2Sub,
            F64x2Mul,       F64x2Div,      F64x2Min,      F64x2Max,      I32x4TruncSatF32x4S, I32x4TruncSatF32x4U,
            F32x4ConvertI32x4S, F32x4ConvertI32x4U,

            // Extended Opcodes (0xFE prefix) - Threads and Atomic Operations
            MemoryAtomicNotify, MemoryAtomicWait32, MemoryAtomicWait64, AtomicFence, I32AtomicLoad, I32AtomicLoad8U,
            I32AtomicLoad16U, I64AtomicLoad, I64AtomicLoad8U, I64AtomicLoad16U, I64AtomicLoad32U, I32AtomicStore,
            I32AtomicStore8, I32AtomicStore16, I64AtomicStore, I64AtomicStore8, I64AtomicStore16, I64AtomicStore32,
            I32AtomicRmwAdd, I32AtomicRmw8AddU, I32AtomicRmw16AddU, I64AtomicRmwAdd, I64AtomicRmw8AddU, I64AtomicRmw16AddU,
            I64AtomicRmw32AddU, I32AtomicRmwSub, I32AtomicRmw8SubU, I32AtomicRmw16SubU, I64AtomicRmwSub, I64AtomicRmw8SubU,
            I64AtomicRmw16SubU, I64AtomicRmw32SubU, I32AtomicRmwAnd, I32AtomicRmw8AndU, I32AtomicRmw16AndU, I64AtomicRmwAnd,
            I64AtomicRmw8AndU, I64AtomicRmw16AndU, I64AtomicRmw32AndU, I32AtomicRmwOr, I32AtomicRmw8OrU, I32AtomicRmw16OrU,
            I64AtomicRmwOr, I64AtomicRmw8OrU, I64AtomicRmw16OrU, I64AtomicRmw32OrU, I32AtomicRmwXor, I32AtomicRmw8XorU,
            I32AtomicRmw16XorU, I64AtomicRmwXor, I64AtomicRmw8XorU, I64AtomicRmw16XorU, I64AtomicRmw32XorU, I32AtomicRmwXchg,
            I32AtomicRmw8XchgU, I32AtomicRmw16XchgU, I64AtomicRmwXchg, I64AtomicRmw8XchgU, I64AtomicRmw16XchgU,
            I64AtomicRmw32XchgU, I32AtomicRmwCmpxchg, I32AtomicRmw8CmpxchgU, I32AtomicRmw16CmpxchgU, I64AtomicRmwCmpxchg,
        ...
        inline std::vector<opcode_entry> const& opcodes()
        {
            ...
            {
                /// @todo verify the following table generated by Grok (2nd attempt) is correct
                ...
                { opcode::I32AtomicLoad,     op2{ 0xFE, 0x10 } },
                { opcode::I64AtomicLoad,     op2{ 0xFE, 0x11 } },
                { opcode::I32AtomicLoad8U,   op2{ 0xFE, 0x12 } },
                { opcode::I32AtomicLoad16U,  op2{ 0xFE, 0x13 } },
                { opcode::I64AtomicLoad8U,   op2{ 0xFE, 0x14 } },
                { opcode::I64AtomicLoad16U,  op2{ 0xFE, 0x15 } },
                { opcode::I64AtomicLoad32U,  op2{ 0xFE, 0x16 } },
                { opcode::I32AtomicStore,    op2{ 0xFE, 0x17 } },
                { opcode::I64AtomicStore,    op2{ 0xFE, 0x18 } },
                { opcode::I32AtomicStore8,   op2{ 0xFE, 0x19 } },
                { opcode::I32AtomicStore16,  op2{ 0xFE, 0x1A } },
                { opcode::I64AtomicStore8,   op2{ 0xFE, 0x1B } },
                { opcode::I64AtomicStore16,  op2{ 0xFE, 0x1C } },
                { opcode::I64AtomicStore32,  op2{ 0xFE, 0x1D } },
                { opcode::I32AtomicRmwAdd,   op2{ 0xFE, 0x1E } },
                { opcode::I64AtomicRmwAdd,   op2{ 0xFE, 0x1F } },
                { opcode::I32AtomicRmw8AddU, op2{ 0xFE, 0x20 } },
                { opcode::I32AtomicRmw16AddU, op2{ 0xFE, 0x21 } },
                { opcode::I64AtomicRmw8AddU, op2{ 0xFE, 0x22 } },
                { opcode::I64AtomicRmw16AddU, op2{ 0xFE, 0x23 } },
                { opcode::I64AtomicRmw32AddU, op2{ 0xFE, 0x24 } },
                { opcode::I32AtomicRmwSub,   op2{ 0xFE, 0x25 } },
                { opcode::I64AtomicRmwSub,   op2{ 0xFE, 0x26 } },
                { opcode::I32AtomicRmw8SubU, op2{ 0xFE, 0x27 } },
                { opcode::I32AtomicRmw16SubU, op2{ 0xFE, 0x28 } },
                { opcode::I64AtomicRmw8SubU, op2{ 0xFE, 0x29 } },
                { opcode::I64AtomicRmw16SubU, op2{ 0xFE, 0x2A } },
                { opcode::I64AtomicRmw32SubU, op2{ 0xFE, 0x2B } },
                { opcode::I32AtomicRmwAnd,   op2{ 0xFE, 0x2C } },
                { opcode::I64AtomicRmwAnd,   op2{ 0xFE, 0x2D } },
                { opcode::I32AtomicRmw8AndU, op2{ 0xFE, 0x2E } },
                { opcode::I32AtomicRmw16AndU, op2{ 0xFE, 0x2F } },
                { opcode::I64AtomicRmw8AndU, op2{ 0xFE, 0x30 } },
                { opcode::I64AtomicRmw16AndU, op2{ 0xFE, 0x31 } },
                { opcode::I64AtomicRmw32AndU, op2{ 0xFE, 0x32 } },
                { opcode::I32AtomicRmwOr,    op2{ 0xFE, 0x33 } },
                { opcode::I64AtomicRmwOr,    op2{ 0xFE, 0x34 } },
                { opcode::I32AtomicRmw8OrU,  op2{ 0xFE, 0x35 } },
                { opcode::I32AtomicRmw16OrU, op2{ 0xFE, 0x36 } },
                { opcode::I64AtomicRmw8OrU,  op2{ 0xFE, 0x37 } },
                { opcode::I64AtomicRmw16OrU, op2{ 0xFE, 0x38 } },
                { opcode::I64AtomicRmw32OrU, op2{ 0xFE, 0x39 } },
                { opcode::I32AtomicRmwXor,   op2{ 0xFE, 0x3A } },
                { opcode::I64AtomicRmwXor,   op2{ 0xFE, 0x3B } },
                { opcode::I32AtomicRmw8XorU, op2{ 0xFE, 0x3C } },
                { opcode::I32AtomicRmw16XorU, op2{ 0xFE, 0x3D } },
                { opcode::I64AtomicRmw8XorU, op2{ 0xFE, 0x3E } },
                { opcode::I64AtomicRmw16XorU, op2{ 0xFE, 0x3F } },
                { opcode::I64AtomicRmw32XorU, op2{ 0xFE, 0x40 } },
                { opcode::I32AtomicRmwXchg,  op2{ 0xFE, 0x41 } },
                { opcode::I64AtomicRmwXchg,  op2{ 0xFE, 0x42 } },
                { opcode::I32AtomicRmw8XchgU, op2{ 0xFE, 0x43 } },
                { opcode::I32AtomicRmw16XchgU, op2{ 0xFE, 0x44 } },
                { opcode::I64AtomicRmw8XchgU, op2{ 0xFE, 0x45 } },
                { opcode::I64AtomicRmw16XchgU, op2{ 0xFE, 0x46 } },
                { opcode::I64AtomicRmw32XchgU, op2{ 0xFE, 0x47 } },
                { opcode::I32AtomicRmwCmpxchg, op2{ 0xFE, 0x48 } },
                { opcode::I64AtomicRmwCmpxchg, op2{ 0xFE, 0x49 } },
                { opcode::I32AtomicRmw8CmpxchgU, op2{ 0xFE, 0x4A } },
                { opcode::I32AtomicRmw16CmpxchgU, op2{ 0xFE, 0x4B } },
                { opcode::I64AtomicRmw8CmpxchgU, op2{ 0xFE, 0x4C } },
                { opcode::I64AtomicRmw16CmpxchgU, op2{ 0xFE, 0x4D } },
                { opcode::I64AtomicRmw32CmpxchgU, op2{ 0xFE, 0x4E } },
            };
            return sOpCodes;
        };
